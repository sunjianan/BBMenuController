...
- (void)layoutSubviews
{
    ...
    if (self.imagePosition == BBAdjustButtonIMGPositionLeft) {
        return;
    }
    ...
    if (self.imagePosition == BBAdjustButtonIMGPositionTop || self.imagePosition == BBAdjustButtonIMGPositionBottom) {
        ...
        if (self.imagePosition == BBAdjustButtonIMGPositionTop) {
    ...
    } else if (self.imagePosition == BBAdjustButtonIMGPositionRight) {
